...
// eslint-disable-next-line
import * as itemsDataFormat from 'pages/CRUD/Items/table/ItemsDataFormatters';
...
const OrdersTable = () => {
  ...
  return (
    <div>
      <Widget title={<h4>{humanize('Orders')}</h4>} disableWidgetMenu>
        ...
        >
          <DataGrid
            ...
            loading={loading}
            onRowClick={(e) => {
              history.push(`/admin/orders/${e.id}/edit`);
            }}
            autoHeight
          />
        </div>
