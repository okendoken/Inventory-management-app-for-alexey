...
import ItemsFormPage from 'pages/CRUD/Items/form/ItemsFormPage';
import ItemsTablePage from 'pages/CRUD/Items/table/ItemsTablePage';
    ...
    <div className={classes.root}>
      ...
      >
        ...
        <Switch>
          ...
          <Route path={'/admin/items'} exact component={ItemsTablePage} />
          <Route path={'/admin/items/new'} exact component={ItemsFormPage} />
          <Route
